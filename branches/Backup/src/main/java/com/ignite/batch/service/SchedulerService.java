...
public class SchedulerService implements SchedulerServiceImpl{
    ...
    public boolean unScheduleJob(String jobName) {
        try {
            ...
            System.out.println("Failed to un-schedule job - {}");
            return false;
        }
    }
    ...
    public boolean deleteJob(BatchScheduleInfo jobInfo) {
        try {
            ...
            System.out.println("Failed to delete job - {}"+ jobInfo.getJobName());
            return false;
        }
    }
    ...
    public boolean pauseJob(BatchScheduleInfo jobInfo) {
        try {
            ...
            System.out.println("Failed to pause job - {}" + jobInfo.getJobName() + e);
            return false;
        }
    }
    ...
    public boolean resumeJob(BatchScheduleInfo jobInfo) {
        try {
            ...
            System.out.println("Failed to resume job - {}"+ jobInfo.getJobName()+ e);
            return false;
        }
    }
    ...
    public boolean startJobNow(BatchScheduleInfo jobInfo) {
        try {
            ...
            System.out.println("Failed to start new job - {}" + jobInfo.getJobName()+ e);
            return false;
        }
    }
}
