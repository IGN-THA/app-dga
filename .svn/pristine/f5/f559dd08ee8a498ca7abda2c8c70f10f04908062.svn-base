...
public class TemplateFormatter {
    ...
    public static String[] formatValue(String attr, HashMap<String, Object> variables) throws DocumentRenderException{
        ...
        try {
            ...
            throw new DocumentRenderException("Syntax is incorrect for Format function "+attr);
        }
        return formattedString;
    }

    public static String[] formatDatetime(String formatNum, HashMap<String, Object> variables){
